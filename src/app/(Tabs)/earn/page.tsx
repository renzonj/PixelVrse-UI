   ...
   return (
      <>
            ...
            <div className='flex-row-between w-full'>
               <div className='flex-col space-y-2'>
                  <div className='flex-row-center gap-2'>
                     <p className='text-xs text-c1-neutral-base'>Daily Limit </p>
                     <IoIosArrowForward size="16" />
                  </div>
                  <div className='flex-row-center gap-2'>
                     <IconContainer className='h-8 rounded-xl'>
                        <AiFillThunderbolt size="19" className='text-c1-primary-base' />
                     </IconContainer>
               ...
               <div className='flex-col-end space-y-2'>
                  <p className='text-xs text-c1-neutral-base'>Balance</p>
                  <div className='flex-row-center gap-2 text-c1-accent1-base'>
         ...
         <div className={`flex-col-center h-60 max-[320px]:h-10 w-full
            bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-c1-primary-base/30 via-c1-primary-base/10 to-background
            `}>

            <div className='h-40 w-40 border m-10 rounded-xl border-c1-neutral-light'></div>

            <div className='relative w-full'>
               <button className='absolute main-button bg-c1-accent1-base text-background w-full h-12 p-0 font-bold'>
                  {data[0].amountToClaim} <span className='text-c1-neutral-light/50'>CLAIM</span>
               </button>
               <p className='absolute py-1 px-2 bg-c1-accent1-dark rounded-tl-2xl rounded-bl-2xl flex-col-center text-2xs font-bold text-c1-neutral-dark'>
         ...
         <div className='flex-row-between rounded-2xl my-16 gap-3 p-4 text-c1-foreground bg-c1-primary-contrast'>
